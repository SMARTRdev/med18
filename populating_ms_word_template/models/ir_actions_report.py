        ...
        if tz_name:
            try:
                ...
                _logger.warn(
                    ...
                    exc_info=True)
        return dt.strftime(
            self.env['res.lang'].search([('code', '=', self.env.user.lang)], limit=1).date_format + " " + self.env[
